...
const services: Service[] = [
  {
    ...
    description:
      "Restore volume and fullness to the skin to reduce the appearance of lines and wrinkles.",
    features: [
      "Lip Enhancement",
      "Cheek Augmentation",
      "Jawline Contouring",
  ...
  },
  {
    ...
    image: "/images/BeforAfter1.jpg",
    description:
      "Reduce the appearance of facial wrinkles by temporarily paralyzing muscles.",
    features: [
      "Forehead Lines",
      "Frown Lines",
      "Crow's Feet",
  ...
  },
  {
    ...
    description:
      "Improve skin texture, tone, and appearance using focused light technology.",
    features: [
      "Skin Resurfacing",
      "Scar Reduction",
  ...
  },
  {
    ...
    description:
      "Revitalize your skin's appearance with advanced non-surgical treatments.",
    features: [
      "Chemical Peels",
      "Microdermabrasion",
      "PRP Therapy",
  ...
  },
  {
    ...
    description: "Reshape and tone specific areas of the body without surgery.",
    features: [
      "CoolSculpting",
